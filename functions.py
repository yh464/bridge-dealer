...
def PrintTable(table):
    ...
    print("{:>5} {:5} {:5} {:5} {:5}".format(
        "NT",
        table.contents.resTable[0][4],
        table.contents.resTable[1][4],
        table.contents.resTable[2][4],
        table.contents.resTable[3][4]))
    for suit in range(0, dds.DDS_SUITS):
        print("{:>5} {:5} {:5} {:5} {:5}".format(
            hands.dcardSuit[suit],
            table.contents.resTable[0][suit],
            table.contents.resTable[1][suit],
            table.contents.resTable[2][suit],
            table.contents.resTable[3][suit]))
    print("")
